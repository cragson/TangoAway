...
class tc_or_vdr_imm : public test_case
{
public:
	tc_or_vdr_imm( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->get_vdr( VDR_0 ).vdr8 == 0x10 && this->get_vdr( VDR_1 ).vdr16 == 0x2000 && this->get_vdr( VDR_2 ).
				vdr32 == 0x3000000 && this->get_vdr( VDR_3 ).vdr64 == 0xDEADAFFE1337 )
			{

...
class tc_mov_vdr_vdr : public test_case
{
public:
	tc_mov_vdr_vdr( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->get_vdr( VDR_0 ).vdr8 == 10 && this->get_vdr( VDR_1 ).vdr64 == 11000000 && this->get_vdr( VDR_2 ).
				vdr16 == 10000 && this->get_vdr( VDR_3 ).vdr32 == 200000 && this->get_vdr( VDR_4 ).
				vdr64 == 11000000 )
			{

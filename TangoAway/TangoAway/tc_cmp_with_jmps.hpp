...
class tc_cmp_with_jmps : public test_case
{
public:
	tc_cmp_with_jmps( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->get_vfr() & vfr_flags::VFR_GREATER_FLAG && this->get_vdr( VDR_0 ).vdr32 == 1337 )
			{

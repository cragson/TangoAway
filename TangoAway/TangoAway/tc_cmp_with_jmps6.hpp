...
class tc_cmp_with_jmps6 : public test_case
{
public:
	tc_cmp_with_jmps6( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->get_vfr() & vfr_flags::VFR_LESS_FLAG && this->get_vdr( VDR_2 ).vdr32 == 1337 )
			{

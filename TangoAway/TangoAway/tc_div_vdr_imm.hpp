...
class tc_div_vdr_imm : public test_case
{
public:
	tc_div_vdr_imm( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->get_vdr( VDR_0 ).vdr8 == 1 && this->get_vdr( VDR_1 ).vdr16 == 2 && this->get_vdr( VDR_2 ).vdr32 ==
				3 && this->get_vdr( VDR_3 ).vdr64 == 4 && this->get_vdr( VDR_4 ).vdr_fl == 5.000012f )
			{

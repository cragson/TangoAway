...
class tc_simple_macro : public test_case
{
public:
	tc_simple_macro( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->m_interp->get_vdr_from_env( VDR_0, this->m_test_env_name ).vdr64 == 1338 && this->m_interp->
				get_vdr_from_env( VDR_1, this->m_test_env_name ).vdr64 == 1337 )
			{

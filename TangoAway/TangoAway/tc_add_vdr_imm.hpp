...
class tc_add_vdr_imm : public test_case
{
public:
	tc_add_vdr_imm( const std::string& path ) : test_case( path ) { }
	...
	void on_case() override
	{
		...
		{
			if( this->get_vdr( VDR_0 ).vdr8 == 0x10 && this->get_vdr( VDR_1 ).vdr16 == 0xAFFE && this->get_vdr( VDR_2 ).
				vdr32 == 100 && this->get_vdr( VDR_3 ).vdr64 == 0x13376077AFFEAFFE && this->get_vdr( VDR_4 ).vdr_fl ==
				13.37f )
			{
